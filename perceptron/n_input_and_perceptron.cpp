...
vector<int> generate_and_targets(const vector<vector<int>>& inputs) {
    vector<int> targets;
...
void train_and_gate(int n) {
    vector<vector<int>> inputs = generate_truth_table(n);
    vector<int> targets = generate_and_targets(inputs);
